...
@Entity
@Table(name = "instructor_detail", schema = "", catalog = "`hb-04-one-to-many-uni`")
public class OneToManyUni_InstructorDetailEntity {
    private int id;
    ...
    public boolean equals(Object o) {
        ...
        OneToManyUni_InstructorDetailEntity that = (OneToManyUni_InstructorDetailEntity) o;
